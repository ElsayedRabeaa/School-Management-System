...
class CreateStudentAccountsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('student_accounts', function (Blueprint $table) {
            ...
            $table->foreignId('process_fees_id')->nullable()->references('id')->on('process_fees')->onDelete('cascade');
            $table->foreignId('student_id')->references('id')->on('students')->onDelete('cascade');
            $table->foreignId('reciept_id')->references('id')->on('reciept_students')->onDelete('cascade');
