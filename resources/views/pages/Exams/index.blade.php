                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('Exams.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{ trans('Exam.add_exam') }}</a><br><br>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel"> {{ trans('Exam.delete') }}</h5>
                                                            ...
                                                            <div class="modal-footer">
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">{{ trans('Exam.close') }}</button>
                                                                    <button type="submit"
                                                                            class="btn btn-danger">{{ trans('Exam.submit') }}</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
