...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Sections_trans.title_page_section') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $list_Sections->getTranslation('name_section', 'ar') }}" required>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $list_Sections->getTranslation('name_section', 'en') }}" required>
                                                                                                <input id="id"
                                                                                                       type="hidden"
                                                                                                       name="id"
                                                                                                       class="form-control"
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <label for="inputName"
                                                                                                   class="control-label">{{ trans('Sections_trans.Name_Teachers') }}</label>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <form
                                                                                        ...
                                                                                        <input id="id" type="hidden"
                                                                                               name="id"
                                                                                               class="form-control"
                                                                                               value="{{ $list_Sections->id }}" required>
                                                                                        <div class="modal-footer">
                                                                                            <button type="button"
                                                                                                    class="btn btn-secondary"
                                                                                                    data-dismiss="modal">{{ trans('Sections_trans.Close') }}</button>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('section.store') }}" method="POST">
                                        ...
                                        <div class="col">
                                            <label for="inputName"
                                                   class="control-label">{{ trans('Sections_trans.Name_Grade') }}</label>
                                            <select name="Grade_id" class="custom-select" required>
                                                <!--placeholder-->
                                        ...
                                        <br>
                                            ...
                                            <div class="col">
                                                ...
                                                <select multiple name="Teacher_Id[]" class="custom-select" required >
                                                    <!--placeholder-->
                                                    <option value="" selected
                                                            disabled>{{ trans('Sections_trans.Select_Teacher') }}
                                                    </option>
                                                    @foreach ($Teachers as $Teacher)
