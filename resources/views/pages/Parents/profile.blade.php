            ...
            <div class="card-body">
                <section>
                    ...
                    <div class="row">
                        ...
                        <p class="text-muted mb-4">{{ trans('profile_of_parent.parent') }}</p>

                        <form action="{{route('update_parent',$information->id)}}" method="post">
                            @csrf
                            {{method_field('PUT')}}
                        ...
                        <br><br>
                        <button type="submit">{{ trans('profile_of_parent.update') }}</button>
