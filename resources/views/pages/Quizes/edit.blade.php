            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('Quizs.update','test')}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="Name_ar" value="{{$quizz->getTranslation('name','ar')}}" class="form-control" required>
                                        <input type="hidden" name="id" value="{{$quizz->id}}">
                                    </div>

                                    <div class="col">
                                        <label for="title">   {{trans('Quizes.Name_ar')}} </label>
                                        <input type="text" name="Name_en" value="{{$quizz->getTranslation('name','en')}}" class="form-control" required>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">  {{trans('Quizes.teacher_name')}} : <span class="text-danger">*</span></label>
