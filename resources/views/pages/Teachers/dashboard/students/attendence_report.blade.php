...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{ trans('attendence.title_page') }}</h4>
        </div>
...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <form action="{{route('attendence_search')}}" method="post">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="card-body datepicker-form">
                            <div class="input-group" data-date-format="yyyy-mm-dd">
                                <input class="form-control range-from date-picker-default" type="date" name="first" placeholder="تاريخ البداية"  required>
                                <span class="input-group-a"> {{ trans('attendence.to') }}</span>
                                <input   class="form-control range-to date-picker-default" type="date" name="end" placeholder="تاريخ النهاية"  required>
                            </div>
                        </div>
                    ...
                    <button type="submit" >{{ trans('students.submit') }}</button>
                </form>
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <tr>
                            ...
                            <th class="alert-success">{{ trans('students.sections') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($stu->attendence_status == 0)
                                        <span class="btn-danger">{{ trans('students.absent') }}</span>
                                    @else
                                        <span class="btn-success">{{ trans('students.present') }}</span>
                                    @endif
                                </td>
                            </tr>
