            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route('Quest.store') }}" method="post" autocomplete="off">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="title" id="input-name"
                                               ...
                                               <input type="hidden" name="id_quiz" value="{{$id_quize}}"  >
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <label for="title" style="color: red"> يجب فصل كل اجابة عن الاخري ب (-)</label>
