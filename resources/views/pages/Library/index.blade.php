                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('library.classroom_name') }}</th>
                                            <th>{{ trans('library.section_name') }}</th>
                                            <th> {{ trans('library.processs') }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @foreach($books as $book)
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- <a href="#" title="تحميل الكتاب" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="fas fa-download"></i></a> --}}
