                            ...
                            <form action="{{route('Subjects.store')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="inputState"> {{ trans('subject.grade_name_subject') }}</label>
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState">{{ trans('subject.subject_class') }} </label>
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState">{{ trans('subject.subject_teacher') }} </label>
    ...
    {{-- <script>
        $(document).ready(function () {
            $('select[name="Grade_id"]').on('change', function () {
                ...
                if (Grade_id) {
                    $.ajax({
                        url: "{{ URL::to('classes_subject') }}/" + Grade_id,
                        type: "GET",
                        dataType: "json",
