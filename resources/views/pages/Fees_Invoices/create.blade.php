...
@section('css')
    @toastr_css
@section('title')
{{ trans('fees.page_title_invoices') }}
                        ...
                        <form class=" row mb-30" action="{{ route('Fees_Invoices.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="repeater">
                                        ...
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input class="btn btn-danger btn-block" data-repeater-delete type="button" value="{{ trans('My_Classes_trans.delete_row') }}" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-20">
                                        <div class="col-12">
                                            <input class="button" data-repeater-create type="button" value="{{ trans('My_Classes_trans.add_row') }}" required/>
                                        </div>
                                    </div><br>
