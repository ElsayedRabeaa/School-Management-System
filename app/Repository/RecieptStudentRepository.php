...
class RecieptStudentRepository implements RecieptStudentRepositoryInterface
{

    public function index()
    {
        $receipt_students = RecieptStudent::all();
    ...
    {
        $receipt_student = RecieptStudent::findorfail($id);
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $receipt_students = new RecieptStudent();
    ...
    public function update($request)
    {
        ...
        try {
            ...
            $receipt_students = RecieptStudent::findorfail($request->id);
            $receipt_students->date = date('Y-m-d');
            $receipt_students->student_id = $request->student_id;
            $receipt_students->Debit = $request->Debit;
            $receipt_students->description = $request->description;
    ...
    {
        try {
            RecieptStudent::destroy($request->id);
